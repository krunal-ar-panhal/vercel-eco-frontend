    ...
    return productData ? (
      <div className="container mx-auto p-6  gap-8">
        ...
        <div className="flex-1 ml-6">
          ...
          {/* Add to Cart Button */}
          <button onClick={()=>addToCart(productData._id,size, token)} className="mt-8 py-3 px-6 rounded-md bg-black text-white font-semibold hover:bg-orange-600 transition active:bg-black">
            ADD TO CART
          </button>
